...
/// Owner shell — Scaffold with professional BottomNavigationBar + Drawer.
/// Tabs: Home, Orders, DC (Delivery), Payments (same as office manager + owner extras via drawer)
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Ambigai Bricks', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18, letterSpacing: -0.3)),
        ...
        child: AnimatedContainer(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(label, style: TextStyle(fontSize: 11, fontWeight: sel ? FontWeight.w700 : FontWeight.w500, color: sel ? AppTheme.primaryColor : const Color(0xFF94A3B8))),
              const SizedBox(height: 3),
              AnimatedContainer(
                duration: const Duration(milliseconds: 200),
                width: sel ? 16 : 0,
                height: 3,
                decoration: BoxDecoration(color: sel ? AppTheme.primaryColor : Colors.transparent, borderRadius: BorderRadius.circular(2)),
              ),
            ],
          ),
        ),
